...
- [docs/samples/](docs/samples/) — the Nordbrot sample note in English, German and Spanish, written to trip every feedback lens; import to test the editor
